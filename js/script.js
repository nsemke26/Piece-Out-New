...
const IMG = './images/movies/joaquin.png';
...
const SOUND = {
  ...
  puzzleStartSrc: './sounds/Puzzle_StartSound.mp3',
  puzzleSelectVolume: 0.55,
  puzzleCompleteVolume: 0.75,
  buttonClickVolume: 0.42,
  invalidMoveVolume: 0.62,
  puzzleStartVolume: 0.65,
};

/*
  online resources used in this project:
  - particles inspiration: https://codepen.io/mayurbirle/pen/KXOdov
  - sliding logic concepts: https://codepen.io/camchambers/pen/rNzdJzG
  - interactive grid ideas: https://codepen.io/losborne24/pen/pozbwyx
  
  gsap documentation: https://gsap.com/docs/v3/
  all sounds are from PIXABAY.
*/
...
const PUZZLES = [
  // Landscapes
  { id:'land-1', title:'Royal Canadian Mint',             description:'An iconic view of the Royal Canadian Mint, known for producing circulation and collector coins.',  category:'landscapes', image: "images/landscapes/landscape-1.jpg", source: "Tourism Winnipeg" },
  { id:'land-2', title:'Exchange District',               description:'Historic warehouse architecture and vibrant streets from Winnipeg’s Exchange District.',           category:'landscapes', image: "images/landscapes/landscape-2.jpg", source: "exchangedistrict.org" },
  { id:'land-3', title:'St Boniface Cathedral',           description:'The remarkable facade and grounds of St Boniface Cathedral, a major historic landmark.',           category:'landscapes', image: "images/landscapes/landscape-3.jpg", source: "commons.wikimedia.org" },
  { id:'land-4', title:'Canadian Museum of Human Rights', description:'The striking modern design of the Canadian Museum for Human Rights in downtown Winnipeg.',         category:'landscapes', image: "images/landscapes/landscape-4.jpg", source: "Adobe Stock" },
  // Movies
  { id:'movie-1', title:'Zootopia',         description:'Detective Judy Hops and Nick Wild from Zootpia solving a crime one again.',                category:'movies', image: "images/movies/zootopia.jpg", source: "Disney" },
  { id:'movie-2', title:'Ratatouille',      description:'Remy, a rat with a passion for cooking, helps create unforgettable dishes in Paris.',      category:'movies', image: "images/movies/ratatoullie.jpg", source: "Pixar" },
  { id:'movie-3', title:'Shrek',            description:'Shrek and Donkey set out on a hilarious adventure through a fairy-tale world.',            category:'movies', image: "images/movies/shrek.jpg", source: "DreamWorks" },
  { id:'movie-4', title:'Despicable Me',    description:'Gru and his mischievous Minions pull off wild schemes that turn into family moments.',     category:'movies', image: "images/movies/despicable.jpg", source: "Illumination" },
  // Animals
  { id:'anim-1', title:'Small Birdie',      description:'The small bird sits in the water for a refreshing summer bath.',                           category:'animals', image: "images/animals/animals-1.jpg", source: "Freepik.com" },
  { id:'anim-2', title:'floppy Bunny',      description:'The bunny with floppy ears listening to the breeze and the summer sounds.',                category:'animals', image: "images/animals/animals-2.jpg", source: "Freepik.com" },
  { id:'anim-3', title:'Sleepy Kitty',      description:'The sleepy kitty is taking an afternoon nap in the sunlight.',                             category:'animals', image: "images/animals/animals-3.jpg", source: "Freepik.com" },
  { id:'anim-4', title:'Tuff Puppies',      description:'Two puppies posing on the beach, showing the world just how tuff they are.',               category:'animals', image: "images/animals/animals-4.jpg", source: "Freepik.com" },
  // Food
  { id:'food-1', title:'Pizza Perfection',  description:'A golden, cheesy pizza with fresh toppings and a perfectly crisp crust.',                  category:'food', image: "images/food/food-1-pizza.jpg", source: "Pexels.com" },
  { id:'food-2', title:'Sushi Platter',     description:'A colorful assortment of sushi rolls and nigiri, neatly arranged and ready to serve.',     category:'food', image: "images/food/food-2-sushi.jpg", source: "Pexels.com" },
  { id:'food-3', title:'Street Tacos',      description:'Fresh street-style tacos packed with vibrant filings, herbs, and bold flavors.',          category:'food', image: "images/food/food-3-tacos.jpg", source: "Pexels.com" },
  { id:'food-4', title:'Caesar Salad',      description:'A crisp Caesar salad with romaine, parmesan, croutons, and creamy dressing.',              category:'food', image: "images/food/food-4-caesar-salad.jpg", source: "Pexels.com" },
  // Art
  { id:'art-1', title:'The Great Wave',     description:"Hokusai's iconic woodblock print captures a towering wave curling over boats beneath Mount Fuji.",              category:'art', image: "images/art/art-1.jpg", source: "The Great Wave off Kanagawa – Katsushika Hokusai, c.1831" },
  { id:'art-2', title:'Starry Night',       description:"Van Gogh's swirling night sky glows above a quiet village in one of the world's most recognizable paintings.",  category:'art', image: "images/art/art-2.jpg", source: "The Starry Night – Vincent van Gogh, 1889" },
  { id:'art-3', title:'Water Lilies',       description:"Monet's serene scene of floating lilies reflects light, color, and movement across the water's surface.",       category:'art', image: "images/art/art-3.jpeg", source: "Water Lilies – Claude Monet, c.1916" },
  { id:'art-4', title:'American Gothic',    description:"Grant Wood's famous portrait presents a stern farmer and his daughter before a simple rural home.",             category:'art', image: "images/art/art-4.jpg", source: "American Gothic – Grant Wood, 1930" },
];
const NAME_PRE = [
...
// cache all dom references to avoid repeated queries.
function cacheDom() {
  dom.screens        = $$('.screen');
  ...
  dom.detailsSource  = $('#details-source');
...
function initSounds() {
  ...
  sounds.puzzleStart = createSound(SOUND.puzzleStartSrc, SOUND.puzzleStartVolume);
}
...
// leaderboard storage scoped by puzzle id.
...
function showScreen(id) {
  ...
  if (id === 'leaderboard') {
    // tiny delay for dom reflow before animations.
...
function initCategories() {
  ...
  */
  ...
  dom.btnRandom.addEventListener('click', () => {
    const list = puzzlesForCategory(state.selectedCategory);
...
function showDetails(puzzleId) {
  ...
  dom.detailsSource.innerHTML = `<strong>Source:</strong> <strong>${pz.source || 'N/A'}</strong>`;
...
// shuffle from solved state using valid moves.
...
// create tile nodes and assign image slices.
...
// sync logical board state into dom.
...
function onPointerMove(e) {
  ...
  /*
    pointermove can fire faster than screen paint.
    batch updates into requestAnimationFrame.
  */
...
async function startGame(puzzleId) {
  ...
  playSound('puzzleStart');
  startTimer();
}

// finish run: score, rank, and ui.
function endGame() {
  killGameIntro();
  hidePuzzleReference();
...
// reset keeps same puzzle but reshuffles.
function resetGame() {
...
// show targeting reference modal.
...
// show global scores for current puzzle.
...
// in-game controls and hold-to-preview.
...
function bindTactileButton(el) {
  ...
  // use gsap for smooth press movement.
...
function initGlobalButtonSound() {
  document.addEventListener('click', (e) => {
    ...
    if (!button || button.dataset.tactileBound === '1') return;
    playSound('buttonClick');
  });
}
